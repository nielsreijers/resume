...
\begin{itemize}
	\item\small{2013 -- 2018: Developed a Java Virtual Machine for resource-constrained Internet-of-Things devices such as the Atmel ATMEGA128.}
...
\begin{itemize}
\item\small{Master thesis research.}
\item\small{Worked in the "Anois" and "Cortex" European research projects on augmented reality games.}
	\begin{itemize}
	\item[-]\small{Improving GPS localization accuracy.}
...
\begin{itemize}
	\item\small{Part time work during my Master degree.}
